const CACHE = "financial-tracker-v6";
const ASSETS = ["./", "./index.html", "./debts.html", "./tasks.html", "./styles.css", "./app.js", "./debts.js", "./tasks.js", "./cloud.js", "./firebase-config.js", "./manifest.json", "./icon.svg"];
